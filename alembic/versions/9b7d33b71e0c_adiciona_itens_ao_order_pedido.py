"""adiciona itens ao Order/pedido

Revision ID: 9b7d33b71e0c
Revises: 
Create Date: 2025-09-16 22:24:50.895068
...
def upgrade() -> None:
    ...
    sa.Column('preco_unit', sa.Float(), nullable=True),
